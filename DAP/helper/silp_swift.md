# PROPERTIES_HELPER(type) #
```swift
public func add${type}(path: String, _ value: ${type}) -> ${type}Property? {
...
public func get${type}(path: String) -> ${type}? {
    if let property: ${type}Property = get(path) {
...
public func set${type}(path: String, _ value: ${type}) -> Bool? {
    if let property: ${type}Property = get(path) {
...
# VARS_HELPER(type) #
```swift
public func add${type}(path: String, _ value: ${type}) -> ${type}Var? {
...
# CONTEXT_PROPERTIES_HELPER(type) #
```swift
public func add${type}(path: String, _ value: ${type}) -> ${type}Property? {
